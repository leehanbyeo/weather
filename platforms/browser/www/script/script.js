...
//    }
    ...
    //      mode=json
    //      units=metric
    //      appid=66bd080c8df9f92424c7e7390f67d059
    var link = "http://api.openweathermap.org/data/2.5/forecast";
    var myid = "66bd080c8df9f92424c7e7390f67d059";
    ...
    function suc(result){
        ...
        if(now < sunset){
            ...
            }else if(icontxt == "fas fa-cloud"||icontxt == "fas fa-cloud-sun"||icontxt == "fas fa-smog"){
                $("section").css("background-image", "url(images/day_cloud.jpg)");
            }else if(icontxt == "fas fa-bolt"||icontxt == "fas fa-cloud-rain"||icontxt == "fas fa-cloud-showers-heavy"){
            ...
            if(icontxt == "fas fa-sun"){
                ...
                $("section").css("background-image", "url(images/night_cloud.jpg)");
            }else if(icontxt == "fas fa-bolt"||icontxt == "fas fa-cloud-rain"||icontxt == "fas fa-cloud-showers-heavy"){
                $("section").css("background-image", "url(images/night_rain.jpg)");
            }else if(icontxt == "fas fa-snowflake"){
                $("section").css("background-image", "url(images/night_snow.jpg)");
            }
        }
    }
